...
public class TopTagsInVideosCategoriesInMemory {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        for (Job job: jobs){
            job.setJarByClass(TopTagsInVideosCategoriesInMemory.class);
        }

        // JOB 1
        MultipleInputs.addInputPath(jobs.get(0), new Path(args[0]), TextInputFormat.class, CategoryTagMapper.class);
        MultipleInputs.addInputPath(jobs.get(0), new Path(args[1]), TextInputFormat.class, CategoryTagMapper.class);
        MultipleInputs.addInputPath(jobs.get(0), new Path(args[2]), TextInputFormat.class, CategoryTagMapper.class);
        ...
        //JOB 3 (JOIN)
        MultipleInputs.addInputPath(jobs.get(2), secondOutputPath, KeyValueTextInputFormat.class, DummyCategoryMapper.class);
        MultipleInputs.addInputPath(jobs.get(2), new Path(args[6]), TextInputFormat.class, CategoryNameMapper.class);
